...
function setup() {
	...
	rectangle1=Bodies.rectangle(400,650,200,20,options);
	World.add(world,rectangle1);
	rectangle2=Bodies.rectangle(300,620,20,100,options);
	World.add(world,rectangle2);
	rectangle3=Bodies.rectangle(500,620,20,100,options);
